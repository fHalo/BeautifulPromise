...
public class RepeatDayDialog extends Dialog{
	...
	public static class Builder {
        ...
        public RepeatDayDialog create() {
        	...
        	dialog = new RepeatDayDialog(context, R.style.Dialog);
            ...
            for(int i = 0 ; i < 7 ; i++){
            	if(dayArr[i]){
            		dayButtonArr[i].setBackgroundResource(R.drawable.button_image_2);
            	}else{
            		dayButtonArr[i].setBackgroundResource(R.drawable.button_image_1);
            	}
            }
		...
		View.OnClickListener buttonClickListener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				case R.id.all_day_button:
					mondayBtn.setBackgroundResource(R.drawable.button_image_2);
					tuesdayBtn.setBackgroundResource(R.drawable.button_image_2);
					wednesdayBtn.setBackgroundResource(R.drawable.button_image_2);
					thursdayBtn.setBackgroundResource(R.drawable.button_image_2);
					fridayBtn.setBackgroundResource(R.drawable.button_image_2);
					saturdayBtn.setBackgroundResource(R.drawable.button_image_2);
					sundayBtn.setBackgroundResource(R.drawable.button_image_2);	
					for(int i=0; i<7 ; i++)
						dayArr[i] = true;
					break;
				...
				case R.id.weekdays_button:
					...
					thursdayBtn.setBackgroundResource(R.drawable.button_image_2);
					fridayBtn.setBackgroundResource(R.drawable.button_image_2);
					saturdayBtn.setBackgroundResource(R.drawable.button_image_1);
					sundayBtn.setBackgroundResource(R.drawable.button_image_1);
					for(int i=0; i<5 ; i++)
						dayArr[i] = true;
					dayArr[5] = false;
					dayArr[6] = false;
				...
				case R.id.weekend_button:
					mondayBtn.setBackgroundResource(R.drawable.button_image_1);
					tuesdayBtn.setBackgroundResource(R.drawable.button_image_1);
					wednesdayBtn.setBackgroundResource(R.drawable.button_image_1);
					thursdayBtn.setBackgroundResource(R.drawable.button_image_1);
					fridayBtn.setBackgroundResource(R.drawable.button_image_1);
					saturdayBtn.setBackgroundResource(R.drawable.button_image_2);
					sundayBtn.setBackgroundResource(R.drawable.button_image_2);
					for(int i=0; i<5 ; i++)
						dayArr[i] = false;
